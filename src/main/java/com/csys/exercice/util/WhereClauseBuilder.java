...
public class WhereClauseBuilder implements Predicate, Cloneable {
    ...
    public <V> WhereClauseBuilder booleanOr(@Nullable Boolean pValue, LazyBooleanExpression pBooleanExpression) {
        return applyIfTrue(pValue, this::or, pBooleanExpression);
    }
